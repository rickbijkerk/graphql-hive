...
![Auth0 Dashboard](./01-dashboard.jpg)
...
![GraphiQL Unauthenticated](./05-graphiql-unauthenticated.jpg)
...
![Auth0 Applications](./06-auth0-applications.jpg)
...
![Auth0 Create Application](./07-auth-create-application.jpg)
...
![Auth0 Create Application](./08-login.jpg)

After a successful login the authentication token is added to the blank page.

![Auth0 Create Application](./09-authentication-token.jpg)
...
![Auth0 Create Application](./10-authenticated-request.jpg)
...
[Envelop examples](https://github.com/dotansimha/envelop/tree/main/examples/graphql-helix).

More information about advanced configuration options can be found on the
[`useAuth0` PluginHub page](https://envelop.dev/plugins/use-auth0).
...
[`useExtendContext` plugin](https://envelop.dev/plugins/use-extend-context).
...
[Envelop Docs](https://envelop.dev/docs).
...
[Draft PR for the Operation Complexity Plugin](https://github.com/dotansimha/envelop/pull/671) or
