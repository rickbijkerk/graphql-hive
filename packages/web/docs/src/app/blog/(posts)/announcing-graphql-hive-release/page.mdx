...
![Schema checks on CI](./schema-checks-gh.png)
...
![Schema checks conditional breaking changes configuration](./schema-checks-conditional-configuration.png)
...
![Hive changes history page](./changes-history.png)
...
![Hive monitoring dashboard](./monitoring-preview.png)
...
![Schema checks Slack message](./slack-schema-change.png)
