...
```graphql filename="Example: Create a Member Role"
...
```graphql filename="Example: Update Member Role"
...
```graphql filename="Example: Delete a Member Role"
...
```graphql filename="Example: Assign a Member Role"
...
```graphql filename="Example: Member Invitations"
...
```graphql filename="Example: Invite Members"
